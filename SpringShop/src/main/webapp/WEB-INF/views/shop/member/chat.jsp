    			...
    			<div class="col">
				    <form id="form1">
				        <div class="form-group">
				            <input type="text" class="form-control" placeholder="상담할 메시지 입력" id="t_send">
				        </div>
				        <div class="form-group">
				            <textarea class="form-control" id="t_recieve"></textarea>
				        </div>
...
function connect() {
	...
	ws.onmessage=function(e){
		console.log("서버가 보낸 데이터 : ", e);
		
		//서버가 보낸 메시지를 area에 누적
		$("#t_recieve").append(e.data + "\n");
	}
	
	ws.onclose=function(){
		console.log("서버와 접속이 끊김");
		//끊기는 시점을 발견할 때, 1초의 시간 뒤에 다시 재접속하여 프로그램의
		//안정성을 높이자
