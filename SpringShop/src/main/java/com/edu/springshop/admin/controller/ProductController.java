...
public class ProductController {
	...
	@PostMapping("/product")
	public ResponseEntity<Message> regist(HttpServletRequest httpServletRequest, Product product){
	...
	public ModelAndView getDetail(HttpServletRequest request, Product product) {
		//3단계
